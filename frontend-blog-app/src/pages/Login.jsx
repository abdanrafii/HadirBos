    ...
    <div className="flex min-h-screen bg-gradient-to-r from-indigo-900 via-blue-800 to-indigo-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 justify-center items-center p-12 relative">
        ...
        <div className="text-center text-white z-10 relative">
          <h2 className="text-4xl font-bold mb-8 leading-tight">Masuk ke akun Anda dan segera selesaikan pekerjaan anda!!</h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="bg-white bg-opacity-95 backdrop-filter backdrop-blur-sm rounded-2xl shadow-2xl p-10 border border-gray-200">
            ...
            <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">Masuk ke akun Anda</h1>
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="flex items-center justify-between mb-8">
                <Link to="/forgot-password" className="text-sm text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-300">
                  Lupa Kata Sandi?
                </Link>
              </div>
              ...
              <div className="mb-6">
                <button
                  className={`w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-300 transform hover:scale-105 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                  type="submit"
                  disabled={loading}
                >
                  {loading ? (
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  Belum punya akun?{' '}
                  <Link to="/register" className="font-semibold text-blue-600 hover:text-blue-800 transition-colors duration-300">
                    Daftar Sekarang
                  </Link>
                </p>
              </div>
